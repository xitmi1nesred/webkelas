...
const Schedule = () => {
    ...
    piketGroup = [
        ["Selvira", "Kesya", "Fazrian", "Revan", "Denis", "Hafizh", "Fikri"],
        ["Sri", "Mikaa", "Gunawan", "Laesa", "Firman", "Syahril","Bani"],
        ["Putri", "Jessica", "Ilham", "Iqbal", "Akamal", "Nafis", "Mulyana"],
        ["Dinda", "Dwi", "Desi", "Fahri R.S", "Lucky", "Riyadhi", "Deas"],
        ["Rizkya", "Adelia", "Sofi", "Faisal", "M. Fahri", "Naoval"]
    ]
